    ...
    <div className="fixed inset-0 z-55 flex items-center justify-center backdrop-blur-sm bg-black/10">
      <div className="relative p-4 w-full max-w-md max-h-full">
        <div className="relative bg-[#D8D4FF] rounded-lg shadow-sm dark:bg-[#D8D4FF]">
            ...
            <h3 className="text-lg font-semibold text-gray-900 font-BTitr dark:text-[#0C1086]">
            ...
            <div className="gap-4 mb-4 ">
                <div className=" w-full">
                    <label htmlFor="category" className="block mb-2 text-lg font-BNazanin font-medium text-gray-900 dark:text-[#0C1086]">دسته بندی</label>
                    <select onChange={(e) => setCategoryId(e.target.value)} id="category" className="bg-gray-50 font-BNazanin text-lg text-[#0C1086] rounded-lg block w-full p-2.5 dark:bg-[#D9D9D9] dark:text-[#0C1086]">
            ...
            <div className="flex justify-center items-center pt-3">
                <button type="submit" className="text-white font-BTitr justify-centerS inline-flex items-center hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#CAA200] dark:hover:bg-[#F9C700] duration-200 ease-in">
