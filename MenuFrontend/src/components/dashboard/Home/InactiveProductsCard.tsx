...
import { useGetInactiveProductsQuery } from "../../../features/Home/inactiveProductsCard/inactiveProductsApi";
import { setInactiveProduct , setLoading , setErorr } from "../../../features/Home/inactiveProductsCard/inactiveProductsSlice";
import InactiveItem from "../../../components/dashboard/shared/inactiveItem";

export default function InactiveProductsCard(){
    const {data , isLoading , error} = useGetInactiveProductsQuery();
    ...
    useEffect(() => {
        ...
        if (data) {
            dispatch(setInactiveProduct(data));
        }
    })
