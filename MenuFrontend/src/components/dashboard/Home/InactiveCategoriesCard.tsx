...
import { useGetInactiveCategoriesQuery } from "../../../features/Home/inactiveCategoriesCard/inactiveCategoriesApi";
import { setInactiveCategories , setLoading , setErorr } from "../../../features/Home/inactiveCategoriesCard/inactiveCategoriesSlice";
...
export default function InactiveCategoriesCard(){
    ...
    useEffect(() => {
        ...
        if (data) {
            dispatch(setInactiveCategories(data));
        }
    })
